package com.artemyakkonen.client_admin.controller;

import com.artemyakkonen.client_admin.dto.MessageResponse;
import com.artemyakkonen.client_admin.dto.UserResponse;
...
private static final URI BASE_URI = URI.create("http://server:8081/server_api/");
    ...
    @Autowired
    public ClientAdminController(RestTemplate restTemplate) {
